...
export function toLinuxPath(windowsPath, { distro = distroName() } = {}) {
  ...
  if (unc) {
    ...
    if (name.toLowerCase() !== String(distro).toLowerCase() && distro !== "WSL") {
      // still convert; note mismatch in advice
    }
